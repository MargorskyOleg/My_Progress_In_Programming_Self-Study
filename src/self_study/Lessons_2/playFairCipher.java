...
public class playFairCipher extends Main {
    ...
    private static String splitStringAsPairs(String a) { //Вариант-2 разделить строку как пары
...
//        System.out.print(strBin);//XE
    ...
    private static String splitStringAsArrayOfFirstLetter(String a) { //Вариант-1 разбиение строки
        int num = a.length();
...
//!этот метод делает массив char [] letter1, но нужно на выходе из метода выходила просто char! чтобы в дальнейшем использовать символы в матрице!
    ...
    private static String splitStringAsArrayOfSecondLetter(String a) { //Вариант-1 разбиение строки
        int num = a.length();
